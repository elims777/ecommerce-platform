        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh' }}>
            ...
            <div style={{ background: 'var(--surface)', padding: 48, overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ maxWidth: 460, margin: '32px auto auto', width: '100%' }}>
                    ...
                    <p style={{ fontSize: 'var(--text-md)', color: 'var(--ink-3)', marginBottom: 20 }}>Выберите тип аккаунта и заполните данные</p>

                    {/* Переключатель */}
                    <div style={{ display: 'flex', background: 'var(--surface-2)', borderRadius: 'var(--r-4)', padding: 4, border: '1px solid var(--line-1)', marginBottom: 24 }}>
