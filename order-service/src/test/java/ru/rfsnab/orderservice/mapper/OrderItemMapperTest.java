    ...
    class ToEntityTests {
        ...
        void shouldMapDtoToEntity() {
            ...
            OrderItemDto dto = new OrderItemDto(1L, "Доска", 10,
                    new BigDecimal("1500.00"), new BigDecimal("15000.00"), "ext-001", null, null, null);
        ...
        void shouldMapDtoListToEntityList() {
            ...
            List<OrderItemDto> dtos = List.of(
                    new OrderItemDto(1L, "Товар 1", 2,
                            new BigDecimal("100.00"), new BigDecimal("200.00"), "ext-001", null, null, null),
                    new OrderItemDto(2L, "Товар 2", 3,
                            new BigDecimal("300.00"), new BigDecimal("900.00"), "ext-002", null, null, null)
            );
