...
/**
 * Проверяет X-Internal-Token на путях service-to-service:
 * запросы из integration-service на импорт каталога и из order-service на чтение товаров.
 * Прочие пути не трогает. Валидный токен ставит ROLE_INTERNAL; невалидный — просто не ставит,
...
public class InternalTokenFilter extends OncePerRequestFilter {
    ...
    private static final List<String> INTERNAL_PATHS = List.of(
            "/api/v1/products/import/batch",
            "/api/v1/products/external/**",
            "/api/v1/categories/upsert-by-external-id"
    );
